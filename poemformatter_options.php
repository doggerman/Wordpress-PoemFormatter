...
/* 
  Option page for Poemformatter wordpress plugin
  blog:   http://wwerther.de
  plugin: http://www.wwerther.de/static/poemformatter
*/
?>
<style type="text/css">
    .fileedit-sub {
...
<table border="0">
 <tr>
  <td><p><img src="<?php echo POEMFORMATTER_PLUGIN_URL ?>/icons/poemformatter_Plugin_Logo.png" alt="Poemformatter Logo"></p></td>
  <td style="width:100%"><h2>Poem Formatter Plugin <?php echo POEMFORMATTER_PLUGIN_VER ?> </h2></td>
  </tr></table>
  Please be patient. Option page will be added soon
  <?php exit(); ?>
  <td>
Donate via<br\>
...
<input type="image" src="<?php echo POEMFORMATTER_PLUGIN_ICONS_URL?>PayPal_mark_50x34.gif" border="0" name="submit" alt="Jetzt einfach, schnell und sicher online bezahlen mit PayPal.">
</form>
<a href="http://flattr.com/thing/589137/Wordpress-GPX2-Chart-Plugin" target="_blank"><img src="<?php echo POEMFORMATTER_PLUGIN_ICONS_URL?>flattr-badge-large.png" alt="Flattr this" title="Flattr this" border="0" /></a><br/>
